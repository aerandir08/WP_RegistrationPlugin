...
class Registrator_dev
{
    ...
    {   
        ...
        foreach ($ages as $age)
        {
            ...
            echo '</label>';
            echo '<label>';
            echo '<input type="checkbox" name="cf-terms" required> Ich akzeptiere die <a href="https://badminton-paderborn.de/wp-content/uploads/2020/08/Corona_Maßnahmen_Badminton3.0.pdf" target="_blank">Hygienekonzept</a>.';
            echo '</label>';
            echo '<label>';
            if ($age == 'youth')
            {
